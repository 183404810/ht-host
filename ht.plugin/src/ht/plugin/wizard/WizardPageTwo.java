...
public class WizardPageTwo extends WizardPage{
	private Map<LayoutEnum, Boolean> codeLayoutMap;
	...
	public void createControl(Composite parent){
		this.codeLayoutMap = new HashMap<>(3);
	    ...
	    final Button check_dao = new Button(group, 32);
	    check_dao.setBounds(247, 51, 98, 17);
	    check_dao.setText("Dao层");
	    ...
	    Button check_jsmvc = new Button(group, 32);
	    check_jsmvc.setBounds(10, 105, 98, 17);
	    check_jsmvc.setText("JS MVC层");

	    this.txt_version = new Text(group, 2048);
	    this.txt_version.setToolTipText("此选项在生成java代码的注解中的版本号");
	    this.txt_version.setText("1.0.0");
	    this.txt_version.setBounds(55, 154, 73, 23);

	    Label lblNewLabel = new Label(group, 0);
	    lblNewLabel.setBounds(10, 157, 41, 17);
