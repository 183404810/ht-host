...
//			hashmap.put("Referer", "http://st.uc.belle.net.cn/blf1-uc-web/index.html");
        ...
        String url = "http://st.uc.belle.net.cn/blf1-mdm-web/bas_size_type/list.json";
